...
public class PlasticoCollider : MonoBehaviour
{
    ...
    {
        if (other.gameObject.CompareTag("BasuraPlastico"))
        {
        ...
        else if (other.gameObject.CompareTag("BasuraCarton") || other.gameObject.CompareTag("BasuraLata") || other.gameObject.CompareTag("BasuraElectronicos"))
        {
